      ...
      <div className="container mx-auto px-6 md:px-10">
        ...
        <div className="max-w-8xl mx-auto bg-white md:p-8 pt-3 rounded-lg shadow-md">
          <div className="flex flex-col gap-4">
            ...
            <h5 className="text-2xl font-semibold">Indemnification</h5>
            <p>
            ...
            <h5 className="text-2xl font-semibold">Non-Transferable</h5>
            <p>
            ...
            <h5 className="text-2xl font-semibold">Disclaimer</h5>
            <p>
            ...
            <h5 className="text-2xl font-semibold">Use of Information</h5>
            <p>
            ...
            <h5 className="text-2xl font-semibold">Links to Other Web Sites</h5>
            <p>
